...
public class TestEntidadProducto {
	...
	public static void main(String[] args) {
		...
		*/
		...
		+" Descripción: "+buscarpro.getDescripcl2());
		*/
		...
		System.out.println("Código: "+listar.getIdproductocl2()+ " Nombre: "+listar.getNombrecl2()
		+" Precio: "+listar.getPreciocompcl2()+" Precio compra: "+listar.getPrecioventacl2()
		+" Estado: "+listar.getEstadocl2()+" Descripción: "+listar.getDescripcl2());
