	...
	public static void main(String[] args) {
		...
		/*
				...
				*/
				...
				+" Usuario: "+buscarusu.getUsuariocl2()+" Contraseña: "+buscarusu.getPassword());
				...
				*/
				...
				System.out.println("Código: "+listar.getIdusuariocl2()+ " Usuario: "+listar.getUsuariocl2()
				+" Contraseña: "+listar.getPassword());
